    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <Text style={styles.descricao}>
          App de controle financeiro pessoal desenvolvido com React Native e
          Expo. Permite registrar receitas e despesas, visualizar o saldo e
          acompanhar o histórico de transações. Os dados são armazenados sqlite
          localmente no dispositivo, garantindo privacidade e acesso offline.
        </Text>
